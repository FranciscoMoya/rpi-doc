...
* El modelo B, cuenta con 512MB de RAM y además dispone de un
  ...
  Este periférico añade al sistema un \emph{hub} USB 2.0 y un
...
* El código de \texttt{bootcode.bin} habilita la SDRAM y lee el archivo
...
* El código de \texttt{start.elf} arranca la CPU ARM1176JZF-S. Un archivo adicional
...
* El archivo \texttt{kernel.img} es el primer archivo de la secuencia de arranque que
